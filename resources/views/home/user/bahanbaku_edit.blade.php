            ...
            <div class="row">
              <div class="col-xl-12">
                <div class="card mb-4">
                  ...
                  <form method="post" action="{{route('updateb',$bahanbaku['id'])}}">
                    @csrf
                   
                    <div class="form-group p-3">
                      <div class="mb-2">
                      <label for="exampleInputEmail1">Kode Bahan Baku</label>
                      <input type="text" class="form-control" name="kd_bahan" value="{{$bahanbaku->kd_bahan}}" readonly>
                      </div>
                      <div class="mb-2">
                      ...
                      placeholder="Nama Bahan" value="{{$bahanbaku->nama_bahan}}" name="nama_b" required>
                       @error('nama_b')
                      ...
                      placeholder="Satuan" value="{{$bahanbaku->satuan}}" name="satuan" required>
                       @error('satuan')
                      <div class="invalid-feedback"> {{ $message }}</div>
                      @enderror
                      ...
                      <div class="col-sm-4 mb-2">
                        ...
                        placeholder="Harga" value="{{$bahanbaku->harga}}" name="harga" required>
                         @error('harga')
                        <div class="invalid-feedback"> {{ $message }}</div>
                        @enderror
                        </div>
